...
$(function() {
//10 meter node
Plotly.d3.csv("files/jinja_10m.csv", function(err, rows){
...
//2 meter node
Plotly.d3.csv("files/jinja_2m.csv", function(err, rows){
...
//ground node
Plotly.d3.csv("files/jinja_gnd.csv", function(err, rows){
...
//sink node
Plotly.d3.csv("files/jinja_sink.csv", function(err, rows){
...
//gateway
Plotly.d3.csv("files/jinja_elec.csv", function(err, rows){
