...
$(function() {
//10 meter node
Plotly.d3.csv("files/kamuli_10m.csv", function(err, rows){
...
//2 meter node
Plotly.d3.csv("files/kamuli_2m.csv", function(err, rows){
...
//ground node
Plotly.d3.csv("files/kamuli_gnd.csv", function(err, rows){
...
//sink node
Plotly.d3.csv("files/kamuli_sink.csv", function(err, rows){
...
//gateway
Plotly.d3.csv("files/kamuli_elec.csv", function(err, rows){
