...
$(function() {
//10 meter node
Plotly.d3.csv("files/buyende_10m.csv", function(err, rows){
...
//2 meter node
Plotly.d3.csv("files/buyende_2m.csv", function(err, rows){
...
//ground node
Plotly.d3.csv("files/buyende_gnd.csv", function(err, rows){
...
Plotly.newPlot('precipitaion', data, layout, {response:true});
})

// end of ground node

//sink node
Plotly.d3.csv("files/buyende_sink.csv", function(err, rows){
...
//gateway
Plotly.d3.csv("files/buyende_elec.csv", function(err, rows){
