...
$(function() {
//10 meter node
Plotly.d3.csv("files/lwengo_10m.csv", function(err, rows){
...
//2 meter node
Plotly.d3.csv("files/lwengo_2m.csv", function(err, rows){
...
//ground node
Plotly.d3.csv("files/lwengo_gnd.csv", function(err, rows){
...
//sink node
Plotly.d3.csv("files/lwengo_sink.csv", function(err, rows){
...
//gateway
Plotly.d3.csv("files/lwengo_elec.csv", function(err, rows){
