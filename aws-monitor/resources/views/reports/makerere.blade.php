...
$(function() {
//10 meter node
Plotly.d3.csv("files/makerere_10m.csv", function(err, rows){
...
//2 meter node
Plotly.d3.csv("files/makerere_2m.csv", function(err, rows){
...
//ground node
Plotly.d3.csv("files/makerere_gnd.csv", function(err, rows){
...
//sink node
Plotly.d3.csv("files/makerere_sink.csv", function(err, rows){
...
//gateway
Plotly.d3.csv("files/makerere_elec.csv", function(err, rows){
